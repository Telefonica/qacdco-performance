...
REMOTE_INJECTOR_CONFIG="-R172.16.100.5:24000 -Jserver.rmi.ssl.disable=true -Djava.rmi.server.hostname=172.16.100.5 -Jclient.rmi.localport=25000 -Jmode=Batch"
