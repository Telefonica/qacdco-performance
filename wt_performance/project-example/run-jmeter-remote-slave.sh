...
$JMETER_PATH/bin/JMeterPluginsCMD.sh --generate-csv ${PERFORMANCE_PROJECT_PATH}/output/aggregate.csv --input-jtl ${OUTPUT_FOLDER}/jmeter/samples.csv --plugin-type AggregateReport
