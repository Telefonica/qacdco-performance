...
REMOTE_INJECTOR_CONFIG="-R 52.232.78.44:24000,52.232.78.44:25000 -Jserver.rmi.ssl.disable=true -Djava.rmi.server.hostname=127.0.0.1 -Jclient.rmi.localport=25000 -Jmode=Batch"
