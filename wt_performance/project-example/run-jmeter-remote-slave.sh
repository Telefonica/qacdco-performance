...
/usr/local/apache-jmeter-4.0/bin/JMeterPluginsCMD.sh --generate-csv ${OUTPUT_FOLDER}/jmeter/aggregateresults/aggregate.csv --input-jtl ${OUTPUT_FOLDER}/jmeter/samples.csv --plugin-type AggregateReport
