...
REMOTE_INJECTOR_CONFIG="-R nt-jmeter-slave-1.westeurope.cloudapp.azure.com:24000,nt-jmeter-slave-2.westeurope.cloudapp.azure.com:24000 -Jserver.rmi.ssl.disable=true -Djava.rmi.server.hostname=127.0.0.1 -Jclient.rmi.localport=25000 -Jmode=Batch"
