...
3. Review of metrics:
    Although our Jenkins pipeline generates graphs of results. More information and metrics can be found in the [Performance Reporter](http://qacdco.hi.inet/pre-performance/reporter/projects), and access the execution performed within the LOCUST project for a better analysis.